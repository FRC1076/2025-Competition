...
public class VariableTimePIDController implements Sendable, AutoCloseable {
     ...
     */
    public VariableTimePIDController(double kp, double ki, double kd) {
    ...
    public VariableTimePIDController(double kp, double ki, double kd, DoubleSupplier periodSupplier, double minPeriod, double maxPeriod) {
        m_kp = kp;
        m_ki = ki;
        m_kd = kd;
