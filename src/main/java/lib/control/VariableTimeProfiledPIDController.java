 ...
 */
public class VariableTimeProfiledPIDController implements Sendable {
    private static int instances;

    private VariableTimePIDController m_controller;
     ...
     */
    public VariableTimeProfiledPIDController(
    ...
    public VariableTimeProfiledPIDController(
        ...
        m_controller = new VariableTimePIDController(Kp, Ki, Kd, periodSupplier, minPeriod, maxPeriod);
